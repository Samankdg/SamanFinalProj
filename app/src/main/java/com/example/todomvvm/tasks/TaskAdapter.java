...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> implements Filterable {
    ...
    */
    ...
    public void setTasks(List<TaskEntry> taskEntries) {
        ...
        this.taskEntryList = new ArrayList<>(mTaskEntries);
    ...
    final Filter filter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence.toString().isEmpty()) {
                filteredList.addAll(taskEntryList);
            } else {
        ...
        protected void publishResults(CharSequence constraint, FilterResults filterResults) {
            mTaskEntries.clear();
            mTaskEntries.addAll((Collection<? extends TaskEntry>) filterResults.values);
            notifyDataSetChanged();
        }
    };
